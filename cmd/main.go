...
import (
	...
	computev1 "github.com/dry-4/kubernetes-ec2-operator/api/v1"
	"github.com/dry-4/kubernetes-ec2-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "83126637.cloud.com",
